...
namespace SE3D
{
	...
	public:
		SpotLightComponent(const Vector3D& position = Vector3D(0,0,0), const Vector3D& direction = Vector3D(0,-1,0), const float& cutOff = 12.0f, const float& cutOffOut = 17.0f);
